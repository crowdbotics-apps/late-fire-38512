"""
Django settings for late_fire_38512 project.
...
ROOT_URLCONF = 'late_fire_38512.urls'
...
WSGI_APPLICATION = 'late_fire_38512.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_fire_38512 API",
    "DESCRIPTION": "API documentation for late_fire_38512 App",
    "VERSION": "v1",
}
